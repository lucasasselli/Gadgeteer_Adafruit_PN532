...
namespace Gadgeteer.Modules.Luca_Sasselli
{
    ...
    public class Adafruit_PN532 : Module
    {
        ...
        // Error
        private bool errorNotified = false;
        ...
        /// <summary>Event handler for NFC error</summary>
        ...
        private void Scan()
        {
            while (running)
            {
                var result = ReadPassiveTargetId(MifareIso14443A, threadTimeout);
                if (result != null)
                {
                    var uid = "";
        ...
        private byte[] ReadPassiveTargetId(byte baudrate, int timeout)
        {
            ...
            if (!SendCommandCheckAck(packet, timeout)) return null;
        ...
        private bool IsReady()
        {
            ...
            spi.Write(write);
            spi.WriteRead(Common.CreateNullPayload(1), read);
