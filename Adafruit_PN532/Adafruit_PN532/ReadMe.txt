...
Recommended installation:
 Visual Studio 2015 (community edition or higher) and .NET Micro Framework v4.4 and .NET Micro Framework v4.3
    This allows you to build .NET Gadgeteer module installer for all NETMF versions v4.1 - v4.4
...
This template supports NETMF 4.1, NETMF 4.2, NETMF 4.3 AND NETMF 4.4 - so modules can provide a driver for all versions of NETMF.
...
The template is split into three projects each starting with the name of the module:
 ...
 [ModuleName]_44 : the NETMF 4.4 driver for the module
...
1) [Added in 2.42.600] Only hardware supporting the current project's framework version (i.e. having least one Assembly for that version) will be shown.
   When porting from earlier versions, you must add new items <Assembly MFVersion="4.X" Name="drivername"/> in the <Assemblies> element for each NETMF version X.
